...
module.exports = {
    ...
    // optimization: {  // >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> Fixes module hot reloading (IF USING SEVERAL CHUNKS)
    //     runtimeChunk: 'single'
    // },
    module: {
        rules: [
            ...
            {  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ CSS Rules
                ...
                "css-loader",
                {
                    ...
                    options: {
                        postcssOptions: {
                            plugins: [require('postcss-preset-env')] // TODO: place into var like << const MiniCssExtractPlugin = require("mini-css-extract-plugin"); >>
                        }
                    }
                },
                "sass-loader",
